...
const AIChatbot: React.FC = () => {
  ...
  const saveAIConfig = async () => {
    ...
    if (error) toast({ title: 'Error', description: 'Kon AI-configuratie niet opslaan', variant: 'destructive' });
    else {
      ...
      <div className="max-w-4xl mx-auto">
        ...
        {isAdmin && showConfig && (
          <Card className="bg-white mb-6 shadow-sm">
            <CardHeader><CardTitle>AI Assistent Configuratie</CardTitle></CardHeader>
            <CardContent>
